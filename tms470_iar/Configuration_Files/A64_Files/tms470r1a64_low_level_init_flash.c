...
//
// TITLE:  TMS470R1x low level init for the A64.
//
...
// ======|============= |======|==============================================
//  0.01 | 15 sept 2005 | J.M. | Original
//       |              |      |
//       |              |      |
//       |              |      |
//       |              |      |
...
#include <TexasInstruments/iotms470r1a64.h>
...
int __low_level_init(void)
{
  ...
  // Flash is 64K at 0x00000000 is einitialized as follows
  // Activate Flash at 0x00000000 that is connected to memory select 0,
  // set size to 64KB, enable read-only protection

  MFBAHR0 = 0x00000000;
  MFBALR0 |= BLOCK_SIZE_64K + RONLY;
  ...
  // RAM is 8K at 0x00400000 is einitialized as follows
...
//  SET FLASH WAIT STATES
 ...
 GCR =  ZPLL_MULT4 + ZPLL_CLK_DIV_PRE_1;
